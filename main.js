...
dataAraay.forEach(card => {
    cards.innerHTML += 
    `<div onclick="activeForm(this)" class="card">
            <div class="idnumber">${card.userId}</div>
            <img src="${card.userImage}" alt="${card.userName}">
            <div class="name">${card.userName}</div>
            <div class="surname">${card.userLastName}</div>
            <div class="age">${card.userAge}<span>: Years Old</span></div>
            <div class="adresses">Adresses:<span>${card.userAddresses}</span></div>
    </div>
    `
